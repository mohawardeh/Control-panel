    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(setupAction=> {
                setupAction.SwaggerDoc("InventoryOpenAPISpecification",new Microsoft.OpenApi.Models.OpenApiInfo() {
                    Version="1",
                    Title="Inventory API",
                    Description="Through this API you can access control panel data"
                });
                string xmlCommenctsFileName = $"{Assembly.GetExecutingAssembly().GetName().Name}.xml";
                string xmlCommenctsFilePath = Path.Combine(AppContext.BaseDirectory, xmlCommenctsFileName);
                setupAction.IncludeXmlComments(xmlCommenctsFilePath);
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(setupAction=> {
                setupAction.SwaggerEndpoint("/swagger/InventoryOpenAPISpecification/swagger.json", "Inventory API");
            });
            app.UseStaticFiles();
